        ...
        if(selectedTime != nil && mode == 0){
            ...
            if(AddHabitVC.daysSelected.count != 0){
                ...
                for index in 0..<AddHabitVC.daysSelected.count{
                    ...
                    delegate?.scheduleWeekdayNotifications(at: selectedTime, title: habitDescription.text!, body: bodyContentForNotification, id: tempUUIDs[tempUUIDs.count-1], weekday: gregorianDay)
